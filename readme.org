- pre publication checklist
  - remove tldr title from toc
  - double check mobile experience and add necessary compoonents
  - polish the sample articles
  - modline to contain links for (to be inserted in post0)
    - reddit / youtube / twitter / hn / mastodon / linkedin
    - link to github code
    - link to github change history for this article
    - icons should render only if a link is availble
